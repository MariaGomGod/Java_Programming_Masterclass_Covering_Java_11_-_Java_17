...
public class ScopeCheck {
    ...
    public void timesTwo() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            //System.out.println(i + " times two is " + i * this.var2); // con this.var2 le queremos decir a Java que utilice la variable var2 definida al principio con el valor 1
        }
    }
